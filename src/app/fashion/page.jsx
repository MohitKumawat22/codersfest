...
const products = [
    { id: 4, name: "Leather Travel Bag", price: 85.00, oldPrice: 130.00, rating: 4.6, image: "/p4.jpg", tag: "35% off", color: "bg-red-100 text-red-600" },
    { id: 7, name: "Summer Floral Dress", price: 45.00, oldPrice: 60.00, rating: 4.8, image: "/p7.jpg", tag: "New", color: "bg-green-100 text-green-600" },
    { id: 8, name: "Classic Denim Jacket", price: 75.00, oldPrice: 95.00, rating: 4.7, image: "/p8.jpg", tag: "Trending", color: "bg-blue-100 text-blue-600" },
    { id: 9, name: "Running Sneakers", price: 110.00, oldPrice: 150.00, rating: 4.5, image: "/p9.jpg", tag: "Sale", color: "bg-orange-100 text-orange-600" },
];
